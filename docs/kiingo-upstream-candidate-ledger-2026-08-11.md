...
| Keep the lazy database-pool fixture scanner-safe | [#6410](https://github.com/block/buzz/pull/6410) `4ec2ff820570a47c41a4c562e3e6ba805ee3e312` | lazy read-pool test plus complete-credential-URI scan | Remove when upstream no longer stores the scanner-triggering complete literal and the lazy-pool behavior remains covered. |
