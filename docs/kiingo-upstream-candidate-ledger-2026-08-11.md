...
| Normalize project README HTML safely | [#6409](https://github.com/block/buzz/pull/6409) `c24e31f4c6323977ccc13fb36cddcae87cbf9667` | README normalizer tests (4 passed) and full desktop formatting check | Remove when upstream contains equivalent provider-neutral normalization and tests. |
